    ...
    <header class="bg-white shadow-sm border-b border-gray-200">
        <div class="px-6 py-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4" x-data="{ currentStore: 'main' }">
                ...
                <button id="settings-refresh-metrc" onclick="window.__refreshMetrc && window.__refreshMetrc()" class="px-4 py-2 bg-cannabis-green text-white rounded-lg hover:bg-green-600 transition-colors flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
