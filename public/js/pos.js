...
function cannabisPOS() {
    return {
        ...
        availableDataSources: [
            { id: 'sales', name: 'Sales Transactions', icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' },
            { id: 'inventory', name: 'Inventory Data', icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
            { id: 'customers', name: 'Customer Records', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
            { id: 'employees', name: 'Employee Data', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
            { id: 'products', name: 'Product Catalog', icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
            { id: 'metrc', name: 'METRC Compliance', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3' },
            { id: 'loyalty', name: 'Loyalty Program', icon: 'M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z' },
            { id: 'payments', name: 'Payment Processing', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1' },
            { id: 'taxes', name: 'Tax Records', icon: 'M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z' },
            { id: 'rooms', name: 'Room Management', icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-4m-5 0H3m2 0h2M7 7h10M7 11h10M7 15h10' },
            { id: 'discounts', name: 'Deals & Discounts', icon: 'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z' }
        ],
        ...
        productCategories: [
            'Flower', 'Pre-Rolls', 'Infused', 'Edibles', 'Concentrates',
            'Vape Products', 'Tinctures', 'Topicals', 'Capsules', 'Beverages',
            'Suppositories', 'Clones/Seeds', 'Immature Plants', 'Mature Plants',
            'Hemp', 'Accessories'
        ],
        ...
        oregonSalesLimits: {
            // Recreational Limits
            recreational: {
                'Flower': { limit: 56.7, unit: 'grams', displayName: 'Flower (includes Pre-Rolls)' }, // 2 oz = 56.7g
                'Pre-Rolls': { limit: 56.7, unit: 'grams', displayName: 'Pre-Rolls (counts as Flower)' }, // Same as flower
                'Infused': { limit: 56.7, unit: 'grams', displayName: 'Infused Products (counts as Flower)' }, // Same as flower
                'Concentrates': { limit: 5, unit: 'grams', displayName: 'Concentrates & Extracts' },
                'Vape Products': { limit: 5, unit: 'grams', displayName: 'Vape Products' }, // Same as concentrates
                ...
                'Immature Plants': { limit: 4, unit: 'units', displayName: 'Immature Plants' },
                'Seeds': { limit: 10, unit: 'units', displayName: 'Seeds' }
            },
            // Medical Limits (Higher limits for patients)
            medical: {
                'Flower': { limit: 226.8, unit: 'grams', displayName: 'Flower (includes Pre-Rolls)' }, // 8 oz = 226.8g
                'Pre-Rolls': { limit: 226.8, unit: 'grams', displayName: 'Pre-Rolls (counts as Flower)' }, // Same as flower
                'Infused': { limit: 226.8, unit: 'grams', displayName: 'Infused Products (counts as Flower)' }, // Same as flower
                'Concentrates': { limit: 453.6, unit: 'grams', displayName: 'Concentrates' }, // 16 oz = 453.6g
                'Vape Products': { limit: 5, unit: 'grams', displayName: 'Vape Extracts' }, // Same as recreational extracts
        ...
        async saveProductToApi(productData) {
            ...
            try {
                const result = await posAuth.apiRequest('post', '/products', productData);
                if (result.success) {
        ...
        async updateProductInApi(productId, productData) {
            ...
            try {
                const result = await posAuth.apiRequest('put', `/products/${productId}`, productData);
                if (result.success) {
        ...
        products: [
            {
                ...
                category: "Flower",
                price: 12.00, // Price per gram (will be calculated based on tier)
        ...
        get paginatedProducts() {
            const itemsPerPage = this.viewMode === 'cards' ? this.itemsPerPageCard : this.itemsPerPageList;
        ...
        get paginationInfo() {
            ...
            const endItem = Math.min(this.currentProductPage * itemsPerPage, this.sortedProducts.length);
            return {
                start: startItem,
                end: endItem,
        ...
        handleProductCardClick(product) {
            ...
            if (!product.onSalesFloor) {
                ...
                this.showToast('This product is not currently available for sale', 'error');
                return;
            }
        ...
        addFlowerToCart(product, weight, price) {
            ...
            this.calculateTotals();
            this.showToast(`${product.name} (${weight}g) added to cart for $${price.toFixed(2)}`, 'success');
        },
        ...
        calculateTotals() {
            ...
            const cartDiscountAmount = (this.cartDiscount && this.cartDiscount.amount) ? this.cartDiscount.amount : 0;

            // Calculate final subtotal after all discounts
            const finalSubtotal = Math.max(0, subtotalAfterItemDiscounts - cartDiscountAmount);
        ...
        confirmMedicalSale() {
            ...
            if (!this.medicalData.cardNumber || !this.medicalData.type ||
                !this.medicalData.issueDate || !this.medicalData.expirationDate) {
                this.showToast('Please fill in all required medical information', 'error');
                return;
            }

            // Validate caregiver-specific requirements
            if (this.medicalData.type === 'caregiver' && !this.medicalData.patientCardNumber) {
                this.showToast('Patient card number is required for caregivers', 'error');
                return;
            }
            ...
            if (this.medicalData.saveData) {
                ...
                const existingCustomer = this.customers.find(c => c.medicalCard === this.medicalData.cardNumber);
                if (!existingCustomer) {
            ...
            // Success message
            const customerType = this.selectedCustomer.medicalCardType === 'caregiver' ? 'Caregiver' : 'Medical Patient';
        ...
        loadSettings() {
            try {
                ...
                // Load store settings
                const savedStoreSettings = localStorage.getItem('cannabisPOS-storeSettings');
        ...
        getFlowerTierRange(tierId) {
            ...
            const minPrice = Math.min(prices.weight_1g, prices.weight_3_5g, prices.weight_7g, prices.weight_14g, prices.weight_28g);
            const maxPrice = Math.max(prices.weight_1g, prices.weight_3_5g, prices.weight_7g, prices.weight_14g, prices.weight_28g);
        ...
        executePrint() {
            ...
            const printType = this.printData.type === 'barcode' ? 'QR Code Label' : 'Exit Label';
            const scaleText = this.printData.scale !== 100 ? ` at ${this.printData.scale}% scale` : '';
            const sizeText = this.getLabelSizeDisplay();

            this.showToast(`${printType} printed for ${this.printData.product.name} (${this.printData.copies} copies, ${sizeText}${scaleText})`, 'success');
        ...
        openFlowerDeliModal(product) {
            ...
            if (product.category === 'Flower' && product.priceTier) {
                ...
                if (tier) {
                    ...
                    this.showToast(`Deli-style: Added ${weight}g of ${product.name} from ${this.getFlowerTierName(product.priceTier)} tier`, 'success');
                } else {
        ...
        getCartTotalsByCategory() {
            const totals = {};
            const customerType = (this.selectedCustomer && this.selectedCustomer.isMedical) ? 'medical' : 'recreational';
        ...
        extractWeightInGrams(weightStr) {
            ...
            const match = weightStr.toString().match(/(\d+\.?\d*)\s*(g|gram|grams|oz|ounce|ounces)/i);
            if (!match) return 1;
        ...
        getTotalItemDiscounts() {
            ...
            return this.cart.reduce((total, item) => {
                ...
                return total + ((item.discount && item.discount.amount) ? item.discount.amount * (item.quantity || 1) : 0);
            }, 0);
        },
        ...
        getDiscountedSubtotal() {
            ...
            const cartDiscount = (this.cartDiscount && this.cartDiscount.amount) ? this.cartDiscount.amount : 0;
        ...
        getItemTotal(item) {
            ...
            const itemDiscount = (item.discount && item.discount.amount) ? item.discount.amount * (item.quantity || 1) : 0;
        ...
        applyItemDiscount() {
            if (!this.selectedCartItem || !this.itemDiscountForm.value || this.itemDiscountForm.calculatedAmount <= 0) {
                this.showToast('Please enter a valid discount amount', 'error');
                return;
            }

            if (!this.itemDiscountForm.reason || this.itemDiscountForm.reason.trim() === '') {
        ...
        calculateCartDiscount() {
            if (this.discountForm.type === 'percentage') {
                ...
                this.discountForm.calculatedAmount = baseAmount * (this.discountForm.value / 100);
            } else {
                this.discountForm.calculatedAmount = parseFloat(this.discountForm.value) || 0;
            }
        },
        ...
        applyCartDiscount() {
            ...
            // Success message
            const discountText = this.cartDiscount.type === 'percentage'
        ...
        hasAnyPrices() {
            return Object.values(this.tierForm.prices).some(price => price > 0) ||
                   this.tierForm.customWeights.some(weight => weight.price > 0);
        },

        getTotalWeightsConfigured() {
            let count = Object.values(this.tierForm.prices).filter(price => price > 0).length;
            count += this.tierForm.customWeights.filter(weight => weight.price > 0).length;
            return count;
        },
        ...
        openAgingModal(type, title) {
            ...
            this.agingModalData.totalCost = this.agingModalData.items.reduce((sum, item) => sum + ((item.cost || 0) * item.stock), 0);
            this.agingModalData.totalRetail = this.agingModalData.items.reduce((sum, item) => sum + (item.price * item.stock), 0);
            this.agingModalData.totalProfit = this.agingModalData.totalRetail - this.agingModalData.totalCost;
        ...
        applyDiscountToAgedItem(item) {
            ...
            const discountPercent = prompt(`Enter discount percentage for ${item.name} (e.g., 20 for 20% off):`);
            if (discountPercent && !isNaN(discountPercent)) {
                ...
                if (discount > 0 && discount <= 100) {
                    ...
                    if (productIndex !== -1) {
                        ...
                        this.showToast(`${discount}% discount applied to ${item.name}. New price: $${newPrice.toFixed(2)}`);

                        // Update the aging modal data to reflect the new price
                        const modalItemIndex = this.agingModalData.items.findIndex(i => i.id === item.id);
                        if (modalItemIndex !== -1) {
                            this.agingModalData.items[modalItemIndex].price = newPrice;
                            this.agingModalData.items[modalItemIndex].discountApplied = discount;
                            // Recalculate totals
                            this.agingModalData.totalRetail = this.agingModalData.items.reduce((sum, item) => sum + (item.price * item.stock), 0);
                            this.agingModalData.totalProfit = this.agingModalData.totalRetail - this.agingModalData.totalCost;
                        }
                    ...
                    this.showToast('Please enter a valid discount percentage between 1 and 100.');
                }
            }
        },
        ...
        bulkDiscountAgedItems() {
            ...
            const discountPercent = prompt(`Enter bulk discount percentage for all ${this.agingModalData.items.length} items (e.g., 20 for 20% off):`);
            if (discountPercent && !isNaN(discountPercent)) {
                const discount = parseFloat(discountPercent);
                if (discount > 0 && discount <= 100) {
                    let updatedCount = 0;
                    ...
                    this.showToast(`${discount}% bulk discount applied to ${updatedCount} items.`);
                } else {
                    this.showToast('Please enter a valid discount percentage between 1 and 100.');
                }
            }
        ...
        exportAgingData() {
            ...
            if (!this.agingModalData.items || this.agingModalData.items.length === 0) {
                this.showToast('No data to export.');
                return;
            }

            const csvData = [
                ['Product Name', 'SKU', 'Category', 'Days Old', 'Date Added', 'Stock', 'Cost per Unit', 'Retail per Unit', 'Total Cost', 'Total Retail', 'Room']
            ];
        ...
        printAgingReport() {
            ...
            const printContent = `
                ...
                <table>
                    ...
                    <tbody>
                        ${this.agingModalData.items.map(item => `
                            <tr>
        ...
        executeTransfer() {
            ...
            if (productIndex !== -1) {
                ...
                if (this.transferData.setSalesFloorStatus !== undefined) {
                    this.products[productIndex].onSalesFloor = this.transferData.setSalesFloorStatus;
                }
            ...
            this.showToast(`${product.name} transferred to ${this.transferData.destinationRoom}`, 'success');
            this.showTransferModal = false;
        ...
        saveProductEdit() {
            ...
            if (productIndex !== -1) {
                ...
                this.products[productIndex].metrcData.cbn = parseFloat(this.editData.cbn) || 0;
                this.products[productIndex].metrcData.cbg = parseFloat(this.editData.cbg) || 0;
                this.products[productIndex].metrcData.cbc = parseFloat(this.editData.cbc) || 0;
            }
        ...
        addCustomer() {
            ...
            if (this.customerForm.type === 'medical') {
                ...
                if (this.customerForm.medicalCardType === 'caregiver' && !this.customerForm.patientCardNumber) {
                    this.showToast('Patient card number is required for caregivers', 'error');
                    return;
                }
            }
            ...
            if (this.customerForm.type === 'medical') {
                ...
                if (this.customerForm.medicalCardType === 'caregiver') {
                    newCustomer.patientCardNumber = this.customerForm.patientCardNumber.trim();
                }
            }
            ...
            try {
                const existingCustomers = JSON.parse(localStorage.getItem('cannabisPOS-customers') || '[]');
                existingCustomers.push(newCustomer);
                localStorage.setItem('cannabisPOS-customers', JSON.stringify(existingCustomers));
            } catch (error) {
                console.error('Error saving customer to localStorage:', error);
            }

            this.showToast(`Customer ${newCustomer.name} added successfully`, 'success');
        ...
        completeCashCount() {
            console.log('Complete cash count functionality would be implemented here');
        },

        confirmEmployeeAssignment(employee) {
            console.log('Employee assignment functionality would be implemented here');
        },
        ...
        testMetrcConnection() {
            console.log('Testing METRC connection with settings:', this.metrcSettings);

            // Validate required fields
            if (!this.metrcSettings.apiKey || !this.metrcSettings.userKey) {
                this.showToast('Please enter both API Key and User Key to test connection', 'error');
                return;
            }
            ...
            setTimeout(() => {
                try {
                    ...
                    const isValid = this.metrcSettings.apiKey.length > 10 &&
                                  this.metrcSettings.userKey.length > 10 &&
                                  this.metrcSettings.facilityLicense.length > 3;

                    if (isValid) {
                        this.showToast('METRC connection successful! API credentials verified.', 'success');
                        ...
                        this.showToast('METRC connection failed: Invalid credentials. Please check your API keys.', 'error');
                    }
                } catch (error) {
        ...
        syncMetrcInventory() {
            ...
            if (!this.metrcSettings.facilityLicense) {
                this.showToast('Please enter your Facility License Number before syncing', 'error');
                return;
            }
            ...
            setTimeout(() => {
                try {
                    ...
                    const productsToSync = this.products.filter(p => p.metrcTag && p.metrcTag.length > 0);
                    ...
                    if (synced > 0) {
                        ...
                        this.showToast('No products with METRC tags found to sync', 'warning');
                    }
                } catch (error) {
        ...
        handleCsvFileUpload(event) {
            ...
            this.showToast('CSV file selected. Click preview to validate data.', 'info');
        },
        ...
        previewCsvData() {
            ...
            reader.onload = (e) => {
                try {
                    ...
                    const dataLines = this.csvImportForm.skipFirstRow ? lines.slice(1) : lines;

                    // Parse CSV data
                    const parsedData = dataLines.map((line, index) => {
                        const values = this.parseCsvLine(line);
                        const rowNum = this.csvImportForm.skipFirstRow ? index + 2 : index + 1;
                    ...
                    this.csvImportForm.validRows = parsedData.filter(row => row.valid).length;
                    this.csvImportForm.errorRows = parsedData.filter(row => !row.valid).length;

                    this.showToast(`Preview loaded: ${this.csvImportForm.validRows} valid, ${this.csvImportForm.errorRows} invalid rows`, 'info');
                } catch (error) {
        ...
        validateCsvRow(values, rowNum) {
            ...
            const [name, category, price, cost, stock, weight, thc, cbd, sku, vendor, metrcTag] = values;
            ...
            if (thc && (isNaN(parseFloat(thc)) || parseFloat(thc) < 0 || parseFloat(thc) > 100)) {
                errors.push('THC% must be between 0-100');
            }

            if (cbd && (isNaN(parseFloat(cbd)) || parseFloat(cbd) < 0 || parseFloat(cbd) > 100)) {
        ...
        importCsvData() {
            ...
            reader.onload = (e) => {
                try {
                    ...
                    this.showToast(`CSV import completed! ${imported} products imported, ${skipped} skipped.`, 'success');
                } catch (error) {
                    this.csvImportForm.importing = false;
        ...
        downloadTemplate(category) {
            const templates = {
                'flower': {
                    ...
                    headers: ['Product Name', 'Category', 'Price', 'Cost', 'Stock', 'Weight', 'THC%', 'CBD%', 'CBN%', 'CBG%', 'CBC%', 'SKU', 'Vendor', 'Supplier', 'METRC Tag'],
                    sample: ['Blue Dream', 'Flower', '15.00', '8.00', '250', '28g', '22.5', '0.8', '0.3', '1.2', '0.5', 'BD-001', 'Oregon Cannabis Co.', 'Green Valley Farms', '1A4060300001234000000001']
                },
                'edibles': {
                    filename: 'Edibles_Import_Template.csv',
                    headers: ['Product Name', 'Category', 'Price', 'Cost', 'Stock', 'Weight', 'THC mg', 'CBD mg', 'Total Servings', 'SKU', 'Vendor', 'Supplier', 'METRC Tag'],
                    sample: ['THC Gummy Bears', 'Edibles', '25.00', '12.00', '50', '100mg', '10', '0', '10', 'TGB-001', 'Sweet Relief Co.', 'Edible Solutions', '1A4060300001234000000002']
                },
                'concentrates': {
                    filename: 'Concentrates_Import_Template.csv',
                    headers: ['Product Name', 'Category', 'Price', 'Cost', 'Stock', 'Weight', 'THC%', 'CBD%', 'Extract Type', 'SKU', 'Vendor', 'Supplier', 'METRC Tag'],
                    sample: ['Live Resin Badder', 'Concentrates', '45.00', '25.00', '25', '1g', '78.5', '0.2', 'Live Resin', 'LRB-001', 'Concentrate Co.', 'Extraction Labs', '1A4060300001234000000003']
                },
                'prerolls': {
                    filename: 'PreRolls_Import_Template.csv',
                    headers: ['Product Name', 'Category', 'Price', 'Cost', 'Stock', 'Weight', 'THC%', 'CBD%', 'Pack Size', 'SKU', 'Vendor', 'Supplier', 'METRC Tag'],
                    sample: ['Pre-Roll Pack', 'Pre-Rolls', '12.00', '6.00', '100', '1g', '20.5', '0.5', '1', 'PR-001', 'Roll Co.', 'Pre-Roll Solutions', '1A4060300001234000000004']
                },
                'tinctures': {
                    filename: 'Tinctures_Import_Template.csv',
                    headers: ['Product Name', 'Category', 'Price', 'Cost', 'Stock', 'Volume', 'THC mg/ml', 'CBD mg/ml', 'Total Volume', 'SKU', 'Vendor', 'Supplier', 'METRC Tag'],
                    sample: ['CBD Tincture', 'Tinctures', '35.00', '18.00', '30', '30ml', '1', '25', '30ml', 'TIN-001', 'Tincture Co.', 'Extract Solutions', '1A4060300001234000000005']
                },
                'topicals': {
                    filename: 'Topicals_Import_Template.csv',
                    headers: ['Product Name', 'Category', 'Price', 'Cost', 'Stock', 'Size', 'THC mg', 'CBD mg', 'Application Type', 'SKU', 'Vendor', 'Supplier', 'METRC Tag'],
                    sample: ['Pain Relief Cream', 'Topicals', '28.00', '14.00', '40', '50g', '100', '200', 'Cream', 'TOP-001', 'Topical Co.', 'Wellness Labs', '1A4060300001234000000006']
                },
                'vape': {
                    filename: 'VapeProducts_Import_Template.csv',
                    headers: ['Product Name', 'Category', 'Price', 'Cost', 'Stock', 'Cartridge Size', 'THC%', 'CBD%', 'Hardware Type', 'SKU', 'Vendor', 'Supplier', 'METRC Tag'],
                    sample: ['Hybrid Vape Cart', 'Vape Products', '40.00', '22.00', '60', '1g', '85.2', '0.3', '510 Thread', 'VPC-001', 'Vape Co.', 'Cartridge Solutions', '1A4060300001234000000007']
                },
                'accessories': {
                    filename: 'Accessories_Import_Template.csv',
                    headers: ['Product Name', 'Category', 'Price', 'Cost', 'Stock', 'Material', 'Color', 'Size', 'Brand', 'SKU', 'Vendor', 'Supplier'],
                    sample: ['Glass Pipe', 'Accessories', '18.00', '9.00', '25', 'Glass', 'Clear', 'Medium', 'GlassCo', 'ACC-001', 'Accessory Co.', 'Glass Solutions']
                },
                'hemp': {
                    filename: 'Hemp_Import_Template.csv',
                    headers: ['Product Name', 'Category', 'Price', 'Cost', 'Stock', 'Weight', 'CBD%', 'Delta-8%', 'Delta-9%', 'SKU', 'Vendor', 'Supplier', 'COA Available'],
                    sample: ['Hemp Flower', 'Hemp', '12.00', '6.00', '80', '3.5g', '18.5', '0.2', '0.3', 'HMP-001', 'Hemp Co.', 'Hemp Farms', 'Yes']
                }
            };
        ...
        downloadAllTemplates() {
            const categories = ['flower', 'edibles', 'concentrates', 'prerolls', 'tinctures', 'topicals', 'vape', 'accessories', 'hemp'];
        ...
        removeCustomWeight(index) {
            if (this.tierForm.customWeights && index >= 0 && index < this.tierForm.customWeights.length) {
        ...
        executeMetrcImport() {
            ...
            this.filterProducts();
            this.showToast(`Product "${newProduct.name}" imported successfully from METRC`, 'success');
        ...
        addDrawer() {
            ...
            this.showToast(`Cash drawer "${newDrawer.name}" created successfully`, 'success');
        ...
        confirmEmployeeAssignment(employee) {
            ...
            const drawerIndex = (this.cashDrawers || []).findIndex(d => d.id === this.selectedDrawerForAssignment.id);
            if (drawerIndex !== -1) {
                this.cashDrawers[drawerIndex].assignedEmployee = employee.name;
                this.cashDrawers[drawerIndex].assignedEmployeeId = employee.id;
                this.showToast(`${employee.name} assigned to ${this.selectedDrawerForAssignment.name}`, 'success');
            }
        ...
        updateCustomer() {
            ...
            if (customerIndex !== -1) {
                ...
                this.showToast(`Customer "${this.editCustomerForm.name}" updated successfully`, 'success');
        ...
        addPriceTier() {
            if (!this.tierForm.name || !this.hasAnyPrices()) {
                this.showToast('Please enter tier name and at least one price', 'error');
                return;
            }
        ...
        confirmVoidSale() {
            if (!this.voidForm.reason || !this.voidForm.pinVerified) {
                this.showToast('Please fill in all required fields and verify PIN', 'error');
                return;
            }
        ...
        handleImageUpload(event, type) {
            ...
            if (file) {
                if (type === 'main') {
                    ...
                    this.importForm.additionalImages = this.importForm.additionalImages || [];
                    this.importForm.additionalImages.push(file.name);
                }
        ...
        async handlePinLogin(employeeId, pin) {
            ...
            try {
                ...
                this.loginError = error.response?.data?.message || 'PIN login failed. Please try again.';
            }
        },
        ...
        generateQuickReport(reportType) {
            const reportConfigs = {
                'daily-sales': {
                    ...
                    type: 'sales',
                    dateRange: 'today',
                    metrics: ['total-revenue', 'transaction-count', 'average-order-value', 'units-sold']
                },
                'weekly-sales': {
                    name: 'Weekly Sales Trends',
                    type: 'sales',
                    dateRange: 'last-7-days',
                    metrics: ['total-revenue', 'gross-sales', 'top-selling-products', 'sales-by-category']
                },
                'monthly-sales': {
                    name: 'Monthly Performance',
                    type: 'sales',
                    dateRange: 'this-month',
                    metrics: ['total-revenue', 'net-sales', 'transaction-count', 'sales-per-hour']
                },
                'low-stock': {
                ...
                'inventory-value': {
                    ...
                    type: 'inventory',
                    dateRange: 'today',
                    metrics: ['inventory-value', 'current-stock-levels', 'aging-inventory']
                },
                'aging-inventory': {
                ...
                'top-customers': {
                    ...
                    type: 'customers',
                    dateRange: 'last-30-days',
                    metrics: ['top-customers', 'customer-lifetime-value', 'repeat-customers']
                },
                'customer-loyalty': {
                    name: 'Loyalty Program Report',
                    type: 'customers',
                    dateRange: 'this-month',
                    metrics: ['loyalty-program-stats', 'new-customers', 'customer-retention-rate']
                },
                'customer-demographics': {
                    name: 'Customer Demographics',
                    type: 'customers',
                    dateRange: 'last-30-days',
                    metrics: ['customer-demographics', 'medical-vs-recreational', 'total-customers']
                },
                'employee-sales': {
                ...
                'profit-loss': {
                    ...
                    type: 'financial',
                    dateRange: 'this-month',
                    metrics: ['gross-profit', 'net-profit', 'cost-of-goods-sold', 'operating-expenses']
                },
                'cash-flow': {
            ...
            if (config) {
                ...
                setTimeout(() => {
                    ...
                    // Save to localStorage
                    localStorage.setItem('cannabisPOS-reports', JSON.stringify(this.recentReports));
        ...
        generateReport() {
            ...
            setTimeout(() => {
                ...
                this.showToast(`Custom report "${this.customReport.name}" generated successfully!`, 'success');
        ...
        saveReportTemplate() {
            ...
            this.showToast(`Report template "${this.customReport.name}" saved successfully!`, 'success');
        },
