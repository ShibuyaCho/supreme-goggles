    ...
    Route::prefix('settings')->group(function () {
        ...
        Route::post('/pos', function(\Illuminate\Http\Request $request) {
            ...
            'X-Store-ID' => $storeId,
                                    ...
                                    'Metrc_Integration' => (function($s){ $keys=['metrc_enabled','metrc_user_key','metrc_vendor_key','metrc_facility','metrc_auto_push_sales']; $o=[]; foreach($keys as $k){ if(array_key_exists($k,$s)) $o[$k]=$s[$k]; } return $o; })($settings),
